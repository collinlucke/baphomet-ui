...
export const mockMovies = [
  {
    ...
    revenue: 463517383,
    backdropPath: 'https://example.com/matrix-backdrop.jpg',
    tmdbId: '603'
  },
  {
    id: '2',
    ...
    posterPath: 'https://example.com/godfather-poster.jpg',
    winningPercentage: 92.1,
    overview: 'The patriarch of an organized crime dynasty transfers control.',
    genres: ['Crime', 'Drama'],
    revenue: 246120974,
    backdropPath: 'https://example.com/godfather-backdrop.jpg',
    tmdbId: '238'
  },
  {
    id: '3',
    ...
    posterPath: 'https://example.com/pulpfiction-poster.jpg',
    winningPercentage: 89.3,
    overview: 'The lives of two mob hitmen, a boxer, and others intertwine.',
    genres: ['Crime', 'Drama'],
    revenue: 214179088,
    backdropPath: 'https://example.com/pulpfiction-backdrop.jpg',
    tmdbId: '680'
  }
];
